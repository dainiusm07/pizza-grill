      ...
      <div className="flex flex-col sm:flex-row py-20 text-black items-center">
        ...
        >
          ...
          <p className="mt-6 text-lg text-justify">
            ...
            komanda kiekvieną dieną yra nusiteikusi su meile pagaminti
            ...
            dieną laukiame Jūsų tiek terasoje, tiek vidinėje salėje, kur
            galėsite mėgautis gardžiais patiekalais bei gera atmosfera.
          </p>
        </div>
        <AppImage
