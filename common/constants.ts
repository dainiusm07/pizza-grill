...
export const ABOUT_US_SECTION_ID = "apie-mus";
export const DAILY_LUNCH_MENU_SECTION_ID = "dienos-pietus";
export const REVIEW_SECTION_ID = "atsiliepimai";
export const CONTACTS_SECTION_ID = "kontaktai";
